...
The data used in this paper comes from @citespotifyr. This study uses R packages [@citeR] to clean and analyze the dataset, including libraries from spotifyr [@citespotifyr], tidyverse [@tidyverse], usethis [@usethis], devtools [@devtools].
