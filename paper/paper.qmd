...
@sec-data visualizes the danceability trends for the three artists over time, capturing changes across their discographies from 2010 to 2024. @sec-summary provides data summary table for Ed Sheeran, G.E.M., and JJ Lin, including key metrics such as:

- Danceability: Highlighting the rhythmic appeal of their tracks.
